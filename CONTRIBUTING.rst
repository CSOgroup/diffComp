...
Welcome to ``diffComp`` contributor's guide.
...
If you experience bugs or general issues with ``diffComp``, please have a look
...
You can help improve ``diffComp`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``diffComp`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``diffComp``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n diffComp python=3 six virtualenv pytest pytest-cov
    conda activate diffComp
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/diffComp.git
    cd diffComp
...
#. Install |pre-commit|_::
   ...
   ``diffComp`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/diffComp
.. _issue tracker: https://github.com/<USERNAME>/diffComp/issues
.. <-- end -->
